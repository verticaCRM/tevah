...
<div class="loop-meta" <?php hybrid_attr( 'loop-meta' ); ?>>
	...
	<?php
		...
		elseif( is_search() ) :
			...
			$toivo_archive_title = sprintf( __( 'Search results for &#8220;%s&#8221;', 'tevah' ), get_search_query() );
			$toivo_loop_desc     = sprintf( __( 'You are browsing the search results for &#8220;%s&#8221;', 'tevah' ), get_search_query() );
		elseif( is_author() ) :
