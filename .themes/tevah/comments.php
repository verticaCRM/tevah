...
<div id="comments" class="comments-area">
	...
	<?php if ( 0 == get_comments_number() ) : ?>
		<h2 class="comments-title-no">
			<?php echo __( 'Leave a comment', 'tevah' ); ?>
		</h2>
	<?php endif; ?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<h2 class="comments-title">
			<?php
				printf( _nx( 'One thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'tevah' ),
	...
	?>
		<p class="no-comments"><?php _e( 'Comments are closed.', 'tevah' ); ?></p>
	<?php endif; ?>
