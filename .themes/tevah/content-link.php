...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php hybrid_attr( 'post' ); ?>>
	...
	<div class="entry-inner">
		...
		<header class="entry-header">
			...
			if( is_rtl() ) :
				$toivo_left_or_right = _x( '&larr;', 'Arrow for link post format in right to left languages', 'tevah' );
			else :
				$toivo_left_or_right = _x( '&rarr;', 'Arrow for link post format in left to right languages', 'tevah' );
			endif;
			?>
