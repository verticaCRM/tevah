...
<div id="page" class="site">
	...
	<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'tevah' ); ?></a>
		...
		<div id="top-header" class="top-header">
			...
			<div id="top-header-buttons" class="top-header-buttons">
				<?php if ( has_nav_menu( 'top' ) ) : ?>
					<button id="top-nav-toggle"><?php _e( 'Top Menu', 'tevah' ); ?></button>
				<?php endif; ?>
			
				<?php if ( has_nav_menu( 'social' ) ) : ?>
					<button id="social-nav-toggle"><?php _e( 'Social Menu', 'tevah' ); ?></button>
				<?php endif; ?>
			...
			<div class="wrap-inside">
				...
				<?php
					if ( function_exists( 'breadcrumb_trail' ) && current_theme_supports( 'breadcrumb-trail' ) ) :
						breadcrumb_trail( array( 'container' => 'nav', 'show_on_front' => false, 'show_browse' => false, 'before' => '<h2 class="screen-reader-text">' . esc_attr__( 'Breadcrumbs', 'tevah' ) . '</h2><div class="wrap">', 'after' => '</div>' ) );
					endif;
				?>
