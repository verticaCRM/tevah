				...
				<?php if ( $testimonials->have_posts() ) : ?>
					...
					<div id="testimonial-area" class="testimonial-area front-page-area">
						...
						<?php
							...
							$toivo_lite_testimonial_heading = isset( $jetpack_options['page-title'] ) && '' != $jetpack_options['page-title'] ? esc_html( $jetpack_options['page-title'] ) : esc_html__( 'Testimonials', 'tevah' );
