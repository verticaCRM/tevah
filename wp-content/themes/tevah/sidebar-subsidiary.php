...
?>
	...
	<aside id="sidebar-subsidiary" class="sidebar-subsidiary sidebar" role="complementary" aria-labelledby="sidebar-subsidiary-header" <?php hybrid_attr( 'sidebar', 'subsidiary' ); ?>>
		<h2 class="screen-reader-text" id="sidebar-subsidiary-header"><?php echo esc_attr_x( 'Subsidiary Sidebar', 'Sidebar aria label', 'tevah' ); ?></h2>
		...
		<div class="wrap">
			...
			<?php else : // If the sidebar has no widgets. ?>
				...
				<?php
					the_widget( 'WP_Widget_Search', array( 'title' => __( 'Search', 'tevah' ) ), array(
