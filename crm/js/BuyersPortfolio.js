...
/**
 * BuyersPortfolioManager prototype
 * Instantiates a quick create widget
 */

if (typeof x2 === 'undefined') x2 = {};

x2.BuyersPortfolioManager = (function () {

    function BuyersPortfolioManager (argsDict) {
     ...
     */
    BuyersPortfolioManager.prototype.destructor = function () {
     ...
     */
    BuyersPortfolioManager.prototype._setDefaults = function () {
     ...
     */
    BuyersPortfolioManager.prototype._updateDetailView = function (data) {
        if (data) {
     ...
     */
    BuyersPortfolioManager.prototype._setFormViewValues = function (data) {
     ...
     * also be updated.
     */
    BuyersPortfolioManager.prototype._updateLookupField = function (name, id) {
     ...
     */
    BuyersPortfolioManager.prototype._handleFormSubmission = function (form) {
        var that = this;
     ...
     */
    BuyersPortfolioManager.prototype._setUpOpenDialogBehavior = function () {
        var that = this;
    ...
    BuyersPortfolioManager.prototype._init = function () {
        $(this.element).qtip({content: this.tooltip});
        this._setUpOpenDialogBehavior ();
    };

    return BuyersPortfolioManager;
