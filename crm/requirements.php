...
session_save_path('/hsphere/local/home/ka-ching/demo.businessbrokerscrm.com/sessions/');
...
if($tryAccess){
    ...
    if($requirements['environment']['outbound_connection'] = checkDNS('google.com')){
        ...
        if($requirements['environment']['outbound_connection'] = tryGetRemote('http://www.google.com')){
            ...
            if($requirements['environment']['updates_connection'] = checkDNS('localhost')){
                if(!($requirements['environment']['updates_connection'] = tryGetRemote('http://localhost/installs/registry/reqCheck'))){
                    // 
