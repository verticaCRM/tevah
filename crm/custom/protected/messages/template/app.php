...
// Search Bar
'X2Engine CRM Groupware'=>'CRM Groupware',
'Contact + Action'=>'',
...
'X2Engine is a Customer Relationship Management application <br>designed by John Roberts.'=>'Thank you for using our CRM',
...
'Developer'=>'',
'Yii Extension'=>'',
'Powered by X2Engine'=>'Powered by BBCRM',
'X2Engine Inc. grants you a perpetual, non-exclusive, non-transferable license 			to install and use this Software for your internal business purposes. 			You shall not modify, distribute, license or sublicense the Software. 			Title, ownership, and all intellectual property rights in the Software belong 			exclusively to X2Engine.'=>'All rightes reserved.',
...
'X2Engine Inc. is headquartered in beautiful Santa Cruz, California. We really enjoy meeting customers and partners whenever possible and encourage you to visit our offices when you find yourself in the San Francisco bay area.'=>'Thank you for using our software.',
...
'Your X2Engine session has expired. You may select "cancel" to ignore this message and recover unsaved data from the current page. Otherwise, you will be redirected to the login page.'=>'Your session has expired. You may select "cancel" to ignore this mmessage and recover unsaved data. Otherwise you will be redirected to log in.',
...
'Class "{class}" specified for {attribute} does not have X2LinkableBehavior, and thus cannot be used with relationships.'=>'Class "{class}" specified for {attribute} does not have Linkable Behavior.',
...
'Pie Chart'=>'',
'Stars'=>'',
'The Image Gallery widget currently does not support Internet Explorer. We are looking to resolve this issue for a later release of X2Engine.'=>'Internet Explorer is not supported for the image gallery',
'File'=>'',
'Yesterday'=>'',
'Data Domain'=>'',
'Total Event Count: '=>'',
...
'Auto-Resize Columns'=>'',
'X2Engine is undergoing maintenance; it has been locked by an administrator. Please try again later.'=>'This site is currently in maintenance mode. Try again later.',
