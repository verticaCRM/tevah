...
include("protected/modules/seller/sellerConfig.php");
...
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            <?php $this->renderPartial('application.components.views._detailView', array('model' => $model, 'modelName' => 'seller')); ?>
...
$this->widget('Attachments', array('associationType' => 'seller', 'associationId' => $model->id, 'startHidden' => true));
