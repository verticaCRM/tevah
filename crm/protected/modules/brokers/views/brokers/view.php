...
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            <?php $this->renderPartial('application.components.views._detailView', array('model' => $model, 'modelName' => 'brokers')); ?>
...
$this->widget('Attachments', array('associationType' => 'brokers', 'associationId' => $model->id, 'startHidden' => true));
