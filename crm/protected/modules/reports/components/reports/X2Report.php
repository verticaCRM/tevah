...
abstract class X2Report extends X2Widget {
     ...
     */
    protected $_gridId = 'generated-report'; 
    ...
    abstract protected function getRelatedModelsByLinkField ();
...
//    }
     ...
     *  by attribute name
     */
    protected function getJoinAliases () {
        if (!isset ($this->_joinAliases)) {
        ...
        foreach ($filters as $filter) {
            ...
            switch($operator){
                ...
                case 'empty':
                    ...
                    break;
                case 'list':
                    $filterConditions .= "$attribute IN ".
                        $qpg->bindArray ($value, true);
                    break;
                case 'notList':
                    $filterConditions .= "$attribute NOT IN ".
                        $qpg->bindArray ($value, true);
                    break;
                case 'noContains':
