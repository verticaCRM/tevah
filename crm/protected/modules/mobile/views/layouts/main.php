...
<link rel="icon" href="<?php echo Yii::app()->getFavIconUrl(); ?>" type="image/x-icon0" />
...
<div id="container"> 
	<div id="<?php echo $this->pageId; ?>" data-role="page" data-url="<?php echo $this->dataUrl; ?>/" data-theme="a">
		...
		<div data-role="footer" data-theme="a" style='max-height:1px;'>
			<p>&nbsp;&nbsp;&copy; <?php echo date('Y') . ' ' . CHtml::link('', '#')." ";
            ...
            <div id='logo-container' style="opacity:.001">
            <?php
