...
$modelType = json_encode("Clistings");
...
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            <?php $this->renderPartial('application.components.views._detailView', array('model' => $model, 'modelName' => 'clistings')); ?>
...
$this->widget('Attachments', array('associationType' => 'clistings', 'associationId' => $model->id, 'startHidden' => true));
