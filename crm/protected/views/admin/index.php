...
<?php /* ?>        <div class="cell span-6"><?php echo CHtml::link(Yii::t('admin','Packager'),array('/admin/packager')); ?><br><?php echo Yii::t('admin','Import and Export packages to easily share and use system customizations');?></div><?php */ ?>
    </div>
    <?php $editionEnd('pro'); ?>
</div>
<div class="form x2-layout-island">
    ...
    <?php /* ?>    <div class="cell span-6"><?php echo CHtml::link(Yii::t('admin','Create a Module'),array('/admin/createModule')); ?><br><?php echo Yii::t('admin','Create a custom module to add to the top bar');?></div> <?php */ ?>
