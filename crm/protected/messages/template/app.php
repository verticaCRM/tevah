...
'Your X2Engine session has expired. You may select "cancel" to ignore this message and recover unsaved data from the current page. Otherwise, you will be redirected to the login page.'=>'Your session has expired. Select cancel to recover unsaved data. You will be otherwise be directed to the login page.',
...
'Pie Chart'=>'',
'Stars'=>'',
'The Image Gallery widget currently does not support Internet Explorer. We are looking to resolve this issue for a later release of X2Engine.'=>'Internet Explorer is not supported.',
'File'=>'',
'Yesterday'=>'',
'Data Domain'=>'',
'Total Event Count: '=>'',
...
'Auto-Resize Columns'=>'',
'X2Engine is undergoing maintenance; it has been locked by an administrator. Please try again later.'=>'The CRM is currently in maintenance mode.',
